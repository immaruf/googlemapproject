...
function displayStores(stores) {
    ...
    `;
        document.querySelector(".store-lists").innerHTML = storesHtml;
    }
}
...
function createMarker(latlng, name, address, openStatusText, phoneNumber, index) {
    ...
    var marker = new google.maps.Marker({
        ...
        position: latlng,
        icon: {
            url: "https://cdn0.iconfinder.com/data/icons/flat-world-flags/128/Bangladesh_Flag_Map_County_Pin_National-512.png",
